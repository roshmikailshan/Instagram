...
# Paste the cookies here as a list of dictionaries
...
def download_profile_media(profile_username, output_dir, cookies):
    ...
    for post in profile.get_posts():
        thread = threading.Thread(
            target=download_post, args=(loader, post, output_path)
        )
...
# List of cookies from the provided JSON-like structure
cookies = [
    {
...
download_profile_media(profile_username, output_dir, cookies)
